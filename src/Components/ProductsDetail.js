    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.detail}>
                <h3>{title}</h3>
                <p>{description}</p>
                <p><span className={styles.categoryS}>category:</span>{category}</p>
                <div className={styles.btn}>
                    <span className={styles.priceCont}>{price}$</span> 
                    <div className={styles.btnCart}>
                        ...
                        {quantityCount(state, targetProduct.id) > 0 && <span className={styles.quantitySpan}>{quantityCount(state, targetProduct.id)}</span>}
